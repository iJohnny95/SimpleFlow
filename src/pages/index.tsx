            ...
            <div className="grid gap-8 sm:grid-cols-1 lg:grid-cols-3">
              ...
              <div className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300 hover:shadow-2xl hover:bg-gradient-to-r from-purple-500 via-indigo-500 to-blue-500 hover:text-white flex flex-col group">
                <div className="flex-grow">
                  ...
                  <ul className="text-left mb-6 space-y-2">
                    <li><span className="text-tickBlue font-bold">✔</span> <span className="text-white">Basic automation setup</span></li>
                    <li><span className="text-tickBlue font-bold">✔</span> <span className="text-white">Dashboard integration</span></li>
                    <li><span className="text-tickBlue font-bold">✔</span> <span className="text-white">Reporting tools</span></li>
                  </ul>
                </div>
                <Link href="#contact-us">
              ...
              <div className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300 hover:shadow-2xl hover:bg-gradient-to-r from-purple-500 via-indigo-500 to-blue-500 hover:text-white flex flex-col group">
                <div className="flex-grow">
                  ...
                  <ul className="text-left mb-6 space-y-2">
                    <li><span className="text-tickBlue font-bold">✔</span> <span className="text-white">Advanced automation tools</span></li>
                    <li><span className="text-tickBlue font-bold">✔</span> <span className="text-white">Customizable dashboards</span></li>
                    <li><span className="text-tickBlue font-bold">✔</span> <span className="text-white">In-depth analytics and reporting</span></li>
                    <li><span className="text-tickBlue font-bold">✔</span> <span className="text-white">Ongoing support</span></li>
                  </ul>
                </div>
                <Link href="#contact-us">
                  <button className="w-full bg-teal-400 hover:bg-teal-500 text-gray-900 font-bold rounded-lg py-3 transition-all duration-300 shadow-md hover:shadow-lg">
              ...
              <div className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300 hover:shadow-2xl hover:bg-gradient-to-r from-purple-500 via-indigo-500 to-blue-500 hover:text-white flex flex-col group">
                <div className="flex-grow">
                  ...
                  <ul className="text-left mb-6 space-y-2">
                    <li><span className="text-tickBlue font-bold">✔</span> <span className="text-white">Full-scale automation services</span></li>
                    <li><span className="text-tickBlue font-bold">✔</span> <span className="text-white">Enterprise-level dashboards</span></li>
                    <li><span className="text-tickBlue font-bold">✔</span> <span className="text-white">24/7 dedicated support</span></li>
                    <li><span className="text-tickBlue font-bold">✔</span> <span className="text-white">Tailored data solutions</span></li>
                  </ul>
                </div>
                <Link href="#contact-us">
                  <button className="w-full bg-teal-400 hover:bg-teal-500 text-gray-900 font-bold rounded-lg py-3 transition-all duration-300 shadow-md hover:shadow-lg">
